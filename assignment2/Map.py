...
class Map_Obj:
    ...
    def __init__(self, task: int = 1) -> None:
        ...
        (
            ...
            self.end_goal_pos,
            self.path_to_map,
        ) = self.fill_critical_positions(task)
    ...
    def read_map(self, path: str) -> tuple[np.ndarray, str]:
        ...
        df = pd.read_csv(
            path, index_col=None, header=None
    ...
    def set_cell_value(
        self, pos: list[int, int], value: int, str_map: bool = True
    ):
    ...
    def replace_map_values(
        self, pos: list[int, int], value: int, goal_pos: list[int, int]
    ):
    ...
    def set_start_pos_str_marker(
        self, start_pos: list[int, int], themap: Union[np.ndarray, str]
    ):
    ...
    def set_goal_pos_str_marker(
        self, goal_pos: list[int, int], themap: Union[np.ndarray, str]
    ):
    ...
    def show_map(self, themap: Union[np.ndarray, str] = None, path=None):
